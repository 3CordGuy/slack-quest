...
export interface Achievement {
  ...
  category: "combat" | "class" | "boss" | "death" | "social" | "economy" | "pub" | "quest" | "camp" | "smithy";
}
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  // ── Camp — Gathering ──────────────────────────────────────────────────────
  {
    ...
    flavor: "Every fortune starts with the first swing of a pick.",
    description: "Claim your first gather at camp.",
    icon: "ore",
    gradient: ["#1a1410", "#a78b6a"],
    category: "camp",
  },
  {
    id: "gold_vein",
    title: "Mother Lode",
    flavor: "A glint in the rock that pays for the whole month.",
    description: "Strike a gold vein on a Deep mining run.",
    icon: "gold-bar",
    gradient: ["#451a03", "#fbbf24"],
    category: "camp",
  },
  {
    id: "first_mithril",
    title: "Mithril Pulled",
    flavor: "Light as feather. Hard as fang. Rare as honest scope.",
    description: "Mine your first Mithril Ore.",
    icon: "ore",
    gradient: ["#1a1a3a", "#93c5fd"],
    category: "camp",
  },
  {
    id: "deep_gatherer_10",
    title: "Patient Prospector",
    flavor: "Four hours at a stretch. Ten times over.",
    description: "Claim 10 Deep-tier gathers.",
    icon: "hourglass",
    gradient: ["#0e2a1a", "#4ade80"],
    category: "camp",
  },
  {
    id: "miner_100",
    title: "Pit Worker",
    flavor: "Your shoulders remember every swing.",
    description: "Mine 100 ore total (any type).",
    icon: "ore",
    gradient: ["#1a1410", "#c4956a"],
    category: "camp",
  },
  {
    id: "forager_100",
    title: "Wildcrafter",
    flavor: "The roots know your hands.",
    description: "Forage 100 herbs total (any type).",
    icon: "grass-mushroom",
    gradient: ["#0c1812", "#86efac"],
    category: "camp",
  },
  {
    id: "fisher_100",
    title: "Old Salt",
    flavor: "A hundred nets pulled. A thousand stories untold.",
    description: "Catch 100 fish total (any type).",
    icon: "fishing-hook",
    gradient: ["#0d1620", "#7dd3fc"],
    category: "camp",
  },
  {
    id: "first_tent",
    title: "Camp Expansion",
    flavor: "Two tents. Two pairs of hands. Half the wait.",
    description: "Build your first Worker Tent.",
    icon: "camping-tent",
    gradient: ["#1a1612", "#d4a373"],
    category: "camp",
  },
  {
    id: "full_camp",
    title: "Mining Colony",
    flavor: "Three tents, four hands at work — your camp hums.",
    description: "Build all three Worker Tents.",
    icon: "camping-tent",
    gradient: ["#1a1612", "#fbbf24"],
    category: "camp",
  },
  {
    id: "camp_perks_all",
    title: "Tooled Up",
    flavor: "Quickdry frames. Big Haul. Keen Eye. The full kit.",
    description: "Build every Camp perk (Quickdry Frames, Big Haul, Keen Eye).",
    icon: "anvil",
    gradient: ["#1e3a5f", "#60a5fa"],
    category: "camp",
  },

  // ── Smithy — Forge mastery ────────────────────────────────────────────────
  {
    id: "first_smith_craft",
    title: "Iron From The Forge",
    flavor: "First hammer-strike against your own metal.",
    description: "Craft your first item at the Smithy.",
    icon: "anvil",
    gradient: ["#1e1208", "#e07840"],
    category: "smithy",
  },
  {
    id: "mithril_craft",
    title: "Mithril Smith",
    flavor: "The mithril sings under a careful hammer.",
    description: "Craft a Mithril-tier item at the Smithy.",
    icon: "lightning-sword",
    gradient: ["#1a1a3a", "#93c5fd"],
    category: "smithy",
  },
  {
    id: "smith_25",
    title: "Forge Regular",
    flavor: "Twenty-five honest crafts. The apron is yours.",
    description: "Craft 25 items at the Smithy.",
    icon: "anvil",
    gradient: ["#1e1208", "#fb923c"],
    category: "smithy",
  },
  {
    id: "smith_master_50",
    title: "Forge Master",
    flavor: "Half a hundred. The forge knows your rhythm.",
    description: "Craft 50 items at the Smithy.",
    icon: "fire",
    gradient: ["#451a03", "#fbbf24"],
    category: "smithy",
  },
  ...
  // ── Pub — Errands & patrons ───────────────────────────────────────────────
  {
    ...
    flavor: "The first round of trust. Many more to pour.",
    description: "Complete your first pub errand.",
    icon: "beer-stein",
    gradient: ["#1a1608", "#d4a53a"],
    category: "pub",
  },
  {
    id: "courier_10",
    title: "On The Run",
    flavor: "Always somewhere to be. Always a coin for the road.",
    description: "Complete 10 Courier errands.",
    icon: "footprint",
    gradient: ["#1a1608", "#fbbf24"],
    category: "pub",
  },
  {
    id: "procure_10",
    title: "Quartermaster",
    flavor: "Bring them what they need. They remember.",
    description: "Complete 10 Procure errands.",
    icon: "swap-bag",
    gradient: ["#1a1410", "#c4956a"],
    category: "pub",
  },
  {
    id: "investigate_5",
    title: "Loose Lips",
    flavor: "Half the truth, twice the rumor.",
    description: "Complete 5 Investigate errands.",
    icon: "scroll-unfurled",
    gradient: ["#101820", "#5a8ab5"],
    category: "pub",
  },
  {
    id: "mercy_first",
    title: "A Small Mercy",
    flavor: "Sometimes the kindness is the whole reward.",
    description: "Complete your first Mercy errand.",
    icon: "health-potion",
    gradient: ["#140f22", "#c084fc"],
    category: "pub",
  },
  {
    id: "mercy_5",
    title: "Bringer of Comfort",
    flavor: "Five small kindnesses. A thousand quiet thanks.",
    description: "Complete 5 Mercy errands.",
    icon: "health-potion",
    gradient: ["#140f22", "#a78bfa"],
    category: "pub",
  },
  {
    id: "rare_errand",
    title: "Rumors of Fortune",
    flavor: "The patron unlocks the back room. Just for you.",
    description: "Complete your first Rare errand.",
    icon: "diamond",
    gradient: ["#451a03", "#fde047"],
    category: "pub",
  },
  {
    id: "long_errand",
    title: "The Long Road",
    flavor: "Six hours out, but the pay is worth the dust.",
    description: "Complete your first Long-tier errand.",
    icon: "hourglass",
    gradient: ["#1a1608", "#fb923c"],
    category: "pub",
  },
  {
    id: "long_errand_5",
    title: "Marathon",
    flavor: "The long road, walked five times.",
    description: "Complete 5 Long-tier errands.",
    icon: "hourglass",
    gradient: ["#451a03", "#fbbf24"],
    category: "pub",
  },
  {
    id: "patron_pillar",
    title: "Pillar of the Pub",
    flavor: "One patron's hand on your shoulder. A door always open.",
    description: "Reach max trust (10) with any pub patron.",
    icon: "crowned-heart",
    gradient: ["#1a1608", "#fbbf24"],
    category: "pub",
  },
  {
    id: "patron_friend_all",
    title: "Old Friends",
    flavor: "Three patrons. Three doors. Every back-room open.",
    description: "Reach max trust (10) with every pub patron.",
    icon: "trophy",
    gradient: ["#451a03", "#f59e0b"],
    category: "pub",
  },
