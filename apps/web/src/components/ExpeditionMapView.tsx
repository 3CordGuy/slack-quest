...
// for unknown events, an aura halo for shrines, a tent for camps, a bar
// stack for treasure (no chest.svg in the set), a skull for the boss, footprints for the start.
